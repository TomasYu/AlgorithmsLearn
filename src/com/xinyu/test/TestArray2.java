...
//        System.out.println("耗时："+ ((System.nanoTime() - l)/1000000));
...
//        System.out.println(singleNumber(arr));;
         ...
         */
//        Utils.printArray(intersect(new int[]{3,1,2},new int[]{1,3}));;
...
//                    int int2 = integers.get(1);
//                    int int3 = integers.get(2);
//                    if ((nums[i] == int1 && nums[j] ==int2) || (nums[i] == int2 && nums[j] == int1)
//                            || (nums[i] == int1 && nums[j] == int3)|| (nums[i] == int3 && nums[j] == int1)
//                            || (nums[i] == int2 && nums[j] == int3)|| (nums[i] == int3 && nums[j] == int2)
//                            ) {
//                        continue for2;
//                    }
//                }
...
//        return res;
    ...
    public static int maxProfit(int[] prices) {
        ...
        int profit = 0;
        for (int i = 0, j =i+1; j<length && i<length;){
            //如果说后面一天的价格比前一天高  则买入
            if (prices[i] < prices[j]) {
                ...
                do {
                    salePrice = prices[j];
                    j++;
                }while (j < length && prices[j] > salePrice);
                j--;
